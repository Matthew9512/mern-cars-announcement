...
//       <>
//          {!lsItems.length ? (
//             <div className='px-8 py-16 relative h-[90vh] lg:w-4/5 w-full mx-auto flex flex-col'>
//                <div className='mx-auto'>
//                   <Empty resourceName='followed ads'>
//                      <span className=''>
//                         Add the ad to your watch list in the search results or directly on the ad page.
...
//          ) : (
//             <>
//                <section className='w-[80%] mx-auto grid grid-cols-[repeat(auto-fill,minmax(16em,1fr))] place-items-center pt-24 gap-y-8 relative min-h-[16em]'>
//                   <p className='absolute top-4 left-0 font-semibold text-lg'>Followed annoucement list:</p>
//                   {lsItems.map((item) => (
//                      <div key={item?._id} className='relative'>
//                         <CarCard item={item} />
