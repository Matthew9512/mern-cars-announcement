...
function Modal({ display, setDisplay, item, action, fetchQuery, params }) {
   return createPortal(
      <div
      ...
      >
         <div className='relative w-96 h-48 p-6 bg-primary-white shadow-2xl rounded-md overflow-auto flex gap-2 flex-col'>
            ...
            <p className='text-left'>
               Are you sure that you want to <span className='lowercase'>{action}</span> this {item}? This action
               can&apos;t be undone?
            </p>
